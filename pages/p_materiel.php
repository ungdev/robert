    ...
    $(function() {
        ...
        $('#gestionSousCatMatos').click(function(){
            $('#modalGestionSousCatMatos').dialog({
                    ...
                    buttons: {
                        'Terminé' : function() { sendNewOrderSsCat(); },
        ...
        $('#modalGestionSousCatMatos')
            .on('click', '.modifCatLabel', function() {
                if (modifyingSousCat == false) gestionMatosSousCat($(this));
            });
        $('#modalGestionSousCatMatos')
            .on('blur', '.ssCatInput', function() {
                saveModifSsCat($(this));
            });
        $('#modalGestionSousCatMatos')
            .on('keydown', '.ssCatInput', function(event) {
                if (event.which == 13) saveModifSsCat($(this));
            });
    });
...
<div class="miniSousMenu padV10 printHide">
    ...
    <div class="inline top leftText">
        <div class="sousMenuBtns hide" id="detailMenuBtns">
            ...
            <a class="bouton miniSmenuBtn" id="matos_add_detail" <?= $hideForPoppy; ?> href="#">Ajout</a>
        </div>
    </div>
    ...
    <div class="inline top rightText">
        <div class="sousMenuBtns hide" id="packsMenuBtns">
            ...
            <a class="bouton miniSmenuBtn" id="matos_add_packs" <?= $hideForPoppy; ?> href="#">Ajout</a>
        </div>
    </div>
    ...
    <div class="inline top center" id="filtresDiv">
        ...
        <button class="bouton filtre" id="int-ext" title="matos INTERNE / EXTERNE au Parc">
            <img src="./gfx/icones/matosExterne.png" alt="INT/EXT" width="30">
        </button>
    </div>
</div>
